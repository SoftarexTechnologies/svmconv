...
Painter.prototype.drawText = function(position, text) {
    ...
    this.context.fillText(text, position.x + 0.5, position.y - 0.5);
    return this;
};
 ...
 * @returns {Painter.prototype}
 */
Painter.prototype.setTransform = function(transform, combine) {
    if (combine) {
        transform = math.multiply(math.matrix(this.matrix), math.matrix(transform));
    }
